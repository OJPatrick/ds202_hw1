...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: Hi, my name is **Patrick Origer**. My major is *Software Engineering* and minor is Data Science. I think Data Science and data in general are very interesting. I completed an internship over the some in the realm of Data Analytics and to improve my understanding of Data Science.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: I believe a job where the person works on getting answers from data and information through statistical modeling that one can find useful and worth paying for. I would consider a Statistician to fit this description the most closely. [Hyperlink](https://blog.udacity.com/2018/01/4-types-data-science-jobs.html) and ![Statistician Image.](https://www.ziprecruiter.com/blog/zrs-0005/blog/wp-content/uploads/2019/11/912637018_Statistician-628x353.jpg)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I am most interested in health related data sets. Using health characteristics to better detect if someone has or will likely have a disease.
